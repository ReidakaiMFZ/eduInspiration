    ...
    return (
        <header className='w-full p-2 h-18 flex flex-row items-center justify-between'>
            ...
            <section className='w-1/6 text-lg flex gap-8 flex-row justify-between'>
                <Link to={'/business'} className='h-8 rounded underline'>Empresas</Link>
                <Link to={'/school'} className='h-8 rounded underline'>Escolas</Link>
                <Link to={'/about'} className='h-8 rounded underline'>Sobre Nós</Link>
            </section>
            <section className='w-1/3 items-end text-lg flex gap-4 flex-row-reverse'>
                <button className='h-8 w-1/12 rounded underline'>Login</button>
            </section>
        </header>
    );
}
