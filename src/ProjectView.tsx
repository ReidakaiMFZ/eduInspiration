...
export default function ProjectView() {
  return (
    <div className="flex flex-nowrap flex-row items-stretch">
        <nav className="grid  h-screen w-1/2 justify-center">
        ...
        <div className="min-h-full max-h-screen w-1/2 flex flex-col gap-y-2 mt-10">
            ...
            <div className="flex flex-row-reverse mb-10 mr-10">
                <button type="submit" className="bg-gpink w-64 h-16 rounded-lg">Casar com o projeto</button>
            </div>
        </div>
    </div>
  );
